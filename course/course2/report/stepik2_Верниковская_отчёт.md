...
![Задание №12](image/ST2_67.png){#fig:067 width=70%}

## Маршрутизаця в локальных сетях

Задание №13: прочитав информацию на странице "Виды маршрутизации", я отметила, что вид маршрутизации, при котором маршруты указываются вручную называется *статической маршрутизацией* (рис. [-@fig:068])

![Задание №13](image/ST2_68.png){#fig:068 width=70%}

Задание №14: прочитав информацию на странице "Виды маршрутизации", я отметила, что к протоколам динамической маршрутизации относятся *RIP*, *OSPF* и *EIGRP*  (рис. [-@fig:069])

![Задание №14](image/ST2_69.png){#fig:069 width=70%}

Задание №15: прочитав информацию на странице "Протоколы динамической маршрутизации", я выполнила задание (рис. [-@fig:070])

![Задание №15](image/ST2_70.png){#fig:070 width=70%}

Задание №16: прочитав информацию на странице "Протоколы динамической маршрутизации", я выполнила задание (рис. [-@fig:071])

![Задание №16](image/ST2_71.png){#fig:071 width=70%}

Задание №17: прочитав информацию на странице "Таблица маршрутизации RIP", я отметила, что в таблице маршрутизации присутствуют такие параметры, как *адрес ближайшего маршрутизатора*, *метрика маршрута* и *адрес назначения*  (рис. [-@fig:072])

![Задание №17](image/ST2_72.png){#fig:072 width=70%}

Задание №18: на скрине всё видно (рис. [-@fig:073])

![Задание №18](image/ST2_73.png){#fig:073 width=70%}
...
13. *vboxmanage modifyvm "Windows 10 (Орг. администрирования)" --nic2 none* (рис. [-@fig:074])

![Задание №19. Настройка сети](image/ST2_74.png){#fig:074 width=70%}

Работаем на виртуальной машине «GW». Посмотреть, какие у нас есть сетевые интерфейсы: *ip a*. Должно быть два интерфейса (enp0s3 и enp0s8) (рис. [-@fig:075])

![Задание №19. Проверка сетевых интерфейсов (1)](image/ST2_75.png){#fig:075 width=70%}
...
(рис. [-@fig:076]), (рис. [-@fig:077])

![Задание №19. Открытие файла /etc/network/interfaces в GW](image/ST2_76.png){#fig:076 width=70%}

![Задание №19. Редактирование файла /etc/network/interfaces в GW](image/ST2_77.png){#fig:077 width=70%}

Далее включим сетевые интерфейсы командами *ifdown enp0s3*, *ifup enp0s3* и *ifup enp0s8* (рис. [-@fig:078])

![Задание №19. Включение сетевых интерфейсов](image/ST2_78.png){#fig:078 width=70%}

Проверим успешную настройку: *ip a* (рис. [-@fig:079])

![Задание №19. Проверка успешной настройки в GW](image/ST2_79.png){#fig:079 width=70%} 

Настроим разрешение имён DNS. В файле /etc/resolv.conf должна быть строчка *nameserver 192.168.1.1* (рис. [-@fig:080]), (рис. [-@fig:081])

![Задание №19. Открытие файла /etc/resolv.conf](image/ST2_80.png){#fig:080 width=70%}

![Задание №19. Редактирование файла /etc/resolv.conf](image/ST2_81.png){#fig:081 width=70%}

Установим имя сервера — gw: *hostname gw* и *echo gw > /etc/hostname* (рис. [-@fig:082])

![Задание №19. УСтановка имени сервера - gw](image/ST2_82.png){#fig:082 width=70%} 

В файле /etc/hostname должна быть только одна строка: *gw* (рис. [-@fig:083]), (рис. [-@fig:084])

![Задание №19. Открытие файла /etc/hostname](image/ST2_83.png){#fig:083 width=70%}

![Задание №19. Редактирование файла /etc/hostname](image/ST2_84.png){#fig:084 width=70%}

Далее установим демон маршрутизации frr. Для этого установим маршрутизацию frr: *apt -y install frr* (рис. [-@fig:085])

![Задание №19. Установка маршрутизации frr](image/ST2_85.png){#fig:085 width=70%}
...
(рис. [-@fig:086]), (рис. [-@fig:087])

![Задание №19. Открытие файла /etc/frr/frr.conf](image/ST2_86.png){#fig:086 width=70%}

![Задание №19. Редактирование файла /etc/frr/frr.conf](image/ST2_87.png){#fig:087 width=70%}

В файле /etc/frr/daemons включаем демон маршрутизации протокола RIP: *ripd=yes* (рис. [-@fig:088]), (рис. [-@fig:089])

![Задание №19. Открытие файла /etc/frr/daemons](image/ST2_88.png){#fig:088 width=70%}

![Задание №19. Редактирование файла /etc/frr/daemons](image/ST2_89.png){#fig:089 width=70%}

Включим параметр ядра Linux для IP-forward (ретрансляция пакетов между интерфейсами). Для этого в файле /etc/sysctl.conf надо раскоментировать строчку *net.ipv4.ip_forward=1* (рис. [-@fig:090]), (рис. [-@fig:091])

![Задание №19. Открытие файла /etc/sysctl.conf](image/ST2_90.png){#fig:090 width=70%}

![Задание №19. Редактирование файла /etc/sysctl.conf](image/ST2_91.png){#fig:091 width=70%}

Далее выполним команду *sysctl -p /etc/sysctl.conf* (рис. [-@fig:092])

![Задание №19. Выполнение команды sysctl -p /etc/sysctl.conf](image/ST2_92.png){#fig:092 width=70%}

Перезагрузим демон (сервис) маршрутизации: *systemctl restart frr* (рис. [-@fig:093])

![Задание №19. Перезагрузка демона маршрутизации](image/ST2_93.png){#fig:093 width=70%}

Посмотрим статус сервиса: *systemctl status frr* (рис. [-@fig:094])

![Задание №19. Проверка статуса сервиса](image/ST2_94.png){#fig:094 width=70%}

Работаем на виртуальной машине «Debian 12». Посмотреть, какие у нас есть сетевые интерфейсы: *ip a* (рис. [-@fig:095])

![Задание №19. Проверка сетевых интерфейсов (2)](image/ST2_95.png){#fig:095 width=70%}
...
(рис. [-@fig:096]), (рис. [-@fig:097])

![Задание №19. Открытие файла /etc/network/interfaces в Debian 12](image/ST2_96.png){#fig:096 width=70%}

![Задание №19. Редактирование файла /etc/network/interfaces в Debian 12](image/ST2_97.png){#fig:097 width=70%}

Включим сетевой интерфейс командами *ifdown enp0s3* и *ifup enp0s3* (рис. [-@fig:098])

![Задание №19. Включение сетевого интерфейса](image/ST2_98.png){#fig:098 width=70%}

Проверим успешную настройку: *ip a* (рис. [-@fig:099])

![Задание №19. Проверка успешной настройки в Debian 12](image/ST2_99.png){#fig:099 width=70%} 

ПРоверим пинг до шлюза и пинг до второго интерфейса шлюза командами *ping 192.168.1.254* и *ping 10.0.1.100* (рис. [-@fig:100])

![Задание №19. Проверка пингов](image/ST2_100.png){#fig:100 width=70%} 

Работаем на виртуальной машине «Windows 10 (Орг. администрирования)». Настроим сетевые интерфейсы и сетевую конфигурацию. Для этого перейдём в Параметры, Сеть и Интернет, Состояние, Настройка параметров адаптера. В свойствах адаптера Ethernet убираем протокол IPv6 (рис. [-@fig:101])

![Задание №19. Убираем протокол IPv6](image/ST2_101.png){#fig:101 width=70%} 

Переходим в Протокол IPv4, Свойства. Устанавливаем:

1. IP-адрес: 172.16.1.100
2. Маску подсети: 255.255.0.0
3. Основной шлюз: 172.16.1.254 (рис. [-@fig:102])

![Задание №19. Настройка протокола IPv4](image/ST2_102.png){#fig:102 width=70%}

Диагностика настройки интерфейса и связи до шлюза. Заходим в cmd и выполняем команды *ipconfig* и *ping 172.16.1.254* (рис. [-@fig:103]), (рис. [-@fig:104])

![Задание №19. ipconfig](image/ST2_103.png){#fig:103 width=70%}

![Задание №19. ping 172.16.1.254](image/ST2_104.png){#fig:104 width=70%}
...
1. Windows System, Control Panel, Брандмауэр Защитника Windows, Дополнительные параметры, Inbound Rules, Общий доступ к файлам и принтерам (эхо-запрос - входящий трафик ICMPv4) (рис. [-@fig:105])
2. Windows System, Control Panel, Брандмауэр Защитника Windows, Дополнительные параметры, Inbound Rules, Наблюдение за виртуальной машиной (эхо-запрос - ICMPv4 - входящий трафик) (рис. [-@fig:106])

![Задание №19. Галочки (1)](image/ST2_105.png){#fig:105 width=70%}

![Задание №19. Галочки (2)](image/ST2_106.png){#fig:106 width=70%}

Далее выполним саму практическую работу. Для этого выполняем следующие команды:  

1. tracert 192.168.1.100 (рис. [-@fig:107])
2. ping 192.168.1.100 (рис. [-@fig:108])

(рис. [-@fig:109])

![Задание №19. tracert 192.168.1.100](image/ST2_107.png){#fig:107 width=70%}

![Задание №19. ping 192.168.1.100](image/ST2_108.png){#fig:108 width=70%}

![Задание №19](image/ST2_109.png){#fig:109 width=70%}

## Сервисы электронной почты

Задание №20: прочитав информацию на странице "Условная схема использования протоколов передачи данных при доставке электронного письма от одного адресата до другого", я отметила, что для отправки почты клиентом используется протокол *SMTP* (рис. [-@fig:110])

![Задание №20](image/ST2_110.png){#fig:110 width=70%}

Задание №21: прочитав информацию на странице "Условная схема использования протоколов передачи данных при доставке электронного письма от одного адресата до другого", я отметила, что для получения почты клиентом используется протокол *POP3* (рис. [-@fig:111])

![Задание №21](image/ST2_111.png){#fig:111 width=70%}

Задание №22: прочитав информацию на странице "Условная схема использования протоколов передачи данных при доставке электронного письма от одного адресата до другого", я отметила, что для пересылки почтовых сообщений между почтовыми серверами MTA используется протокол *SMTP* (рис. [-@fig:112])

![Задание №22](image/ST2_112.png){#fig:112 width=70%}

Задание №23: прочитав информацию на странице "Протокол POP3 (Post Office Protocol Version 3)" и "Протокол IMAP ( Internet Message Access Protocol)", я отметила отличительные особенности протоколов IMAP и POP3 (рис. [-@fig:113])

![Задание №23](image/ST2_113.png){#fig:113 width=70%}

Задание №24 (практическая работа): Необходимо установить и настроить серверы MTA postfix и MDA сyrus, авторизацию SASL, а также протестировать работу со своей клиентской машины через MUA Thunderbird. Сначала установим имя машины adm.org командой *hostname adm.org* (рис. [-@fig:114])

![Задание №24. Установка имени машины](image/ST2_114.png){#fig:114 width=70%}

Далее в файле /etc/hostname напишем: adm.org (рис. [-@fig:115]), (рис. [-@fig:116])

![Задание №24. Открытие файла /etc/hostname](image/ST2_115.png){#fig:115 width=70%}

![Задание №24. Редактирование файла /etc/hostname](image/ST2_116.png){#fig:116 width=70%}

В файле /etc/hosts пропишем соответствие IP-адреса машины и сетевого имени: ip-адрес adm.org. Вот так *10.0.2.15 adm adm.org* (рис. [-@fig:117]), (рис. [-@fig:118])

![Задание №24. Открытие файла /etc/hosts](image/ST2_117.png){#fig:117 width=70%}

![Задание №24. Редактирование файла /etc/hosts](image/ST2_118.png){#fig:118 width=70%}

Установим и настроим MTA postfix: *apt -y install postfix*. При установке указываем тип почтовой настройки - Интернет-сайт, а системное почтовое имя - adm.org (рис. [-@fig:119]), (рис. [-@fig:120]), (рис. [-@fig:121])

![Задание №24. Установка MTA postfix](image/ST2_119.png){#fig:119 width=70%}

![Задание №24. Тип почтовой настройки](image/ST2_120.png){#fig:120 width=70%}

![Задание №24. Системное почтовое имя](image/ST2_121.png){#fig:121 width=70%}

После установки в файле конфигурации /etc/postfix/main.cf устанавливаем имя хоcта (находим параметр myhostname и меняем): *myhostname = adm.org* (рис. [-@fig:122]), (рис. [-@fig:123])

![Задание №24. Открытие файла /etc/postfix/main.cf (1)](image/ST2_122.png){#fig:122 width=70%}

![Задание №24. Редактирование файла /etc/postfix/main.cf (1)](image/ST2_123.png){#fig:123 width=70%}

Проверим корректность настроек сервера: *postconf -n* (рис. [-@fig:124])

![Задание №24. Проверка настроек сервера](image/ST2_124.png){#fig:124 width=70%}

Перезапустим сервис postfix и проверим его статус: *systemctl restart postfix* и *systemctl status postfix* (рис. [-@fig:125])

![Задание №24. Перезапуск сервера postfix и проверка его статуса (1)](image/ST2_125.png){#fig:125 width=70%}

Установим и настроим MDA cyrus: *apt -y install cyrus-imapd cyrus-pop3d cyrus-admin* (рис. [-@fig:126])

![Задание №24. Установка MDA cyrus](image/ST2_126.png){#fig:126 width=70%}

После установки в файле конфигурации Cyrus /etc/cyrus.conf закомментируем строки, начинающиеся с nntp и http, строка с lmtpunix должна быть раскомментирована (рис. [-@fig:127]), (рис. [-@fig:128])

![Задание №24. Открытие файла /etc/cyrus.conf](image/ST2_127.png){#fig:127 width=70%}

![Задание №24. Редактирование файла /etc/cyrus.conf](image/ST2_128.png){#fig:128 width=70%}
...
(рис. [-@fig:129]), (рис. [-@fig:130])

![Задание №24. Открытие файла /etc/imapd.conf](image/ST2_129.png){#fig:129 width=70%}

![Задание №24. Редактирование файла /etc/imapd.conf](image/ST2_130.png){#fig:130 width=70%}

Перезапустим сервис cyrus и проверим его статус: *systemctl restart cyrus-imapd* и *systemctl status cyrus-imapd* (рис. [-@fig:131])

![Задание №24. Перезапуск сервера cyrus-imapd и проверка его статуса](image/ST2_131.png){#fig:131 width=70%}

В файле конфигурации /etc/postfix/main.cf добавим параметр для связи с MDA cyrus по протоколу LMTP через сокет: *mailbox_transport = lmtp:unix:/run/cyrus/socket/lmtp* (рис. [-@fig:132]), (рис. [-@fig:133])

![Задание №24. Открытие файла /etc/postfix/main.cf (2)](image/ST2_132.png){#fig:132 width=70%}

![Задание №24. Редактирование файла /etc/postfix/main.cf (2)](image/ST2_133.png){#fig:133 width=70%}

Далее разрешим модулю LMTP работать не в закрытой файловой среде, чтобы получать доступ к сокету, для этого в файле конфигурации /etc/postfix/master.cf приводим строку к виду (убираем запуск в chroot): *lmtp      unix      -        -         n        -           -         lmtp* (рис. [-@fig:134]), (рис. [-@fig:135])

![Задание №24. Открытие файла /etc/postfix/master.cf (1)](image/ST2_134.png){#fig:134 width=70%}

![Задание №24. Редактирование файла /etc/postfix/master.cf (1)](image/ST2_135.png){#fig:135 width=70%}
...
![Задание №24. Редактирование файла /etc/postfix/master.cf (2)](image/ST2_136.png){#fig:136 width=70%}

Выполним для получения доступа postfix к сокету LMTP: *usermod -aG mail postfix* (рис. [-@fig:137])

![Задание №24. Получение доступа postfix к сокету LMTP](image/ST2_137.png){#fig:137 width=70%}

Проверим настройки и перезапустим сервис postfix: *systemctl restart postfix* и *systemctl status postfix* (рис. [-@fig:138])

![Задание №24. Перезапуск сервера postfix и проверка его статуса (2)](image/ST2_138.png){#fig:138 width=70%}

Далее установим простую систему авторизации SASL (Simple Authentication and Security Layer): *apt -y install sasl2-bin*  (рис. [-@fig:139])

![Задание №24. Установка SASL](image/ST2_139.png){#fig:139 width=70%}

Настроим MTA postfix для работы с SASL, для этого добавим в файл конфигурации /etc/postfix/main.cf строку: *smtpd_sasl_auth_enable = yes* (рис. [-@fig:140]), (рис. [-@fig:141])

![Задание №24. Открытие файла /etc/postfix/main.cf (3)](image/ST2_140.png){#fig:140 width=70%}

![Задание №24. Редактирование файла /etc/postfix/main.cf (3)](image/ST2_141.png){#fig:141 width=70%}

После дадим доступ базе данных пользователей /etc/sasldb2, для этого выполним: *usermod -aG sasl postfix* (рис. [-@fig:142])

![Задание №24. Доступ базе данных](image/ST2_142.png){#fig:142 width=70%} 

Разрешим модулю SMTP работать не в закрытой файловой среде, чтобы получать доступ к базе данных пользователей /etc/sasldb2, для этого в файле конфигурации /etc/postfix/master.cf приведём строку к виду (убираем запуск в chroot): *smtp         inet          n         -         n        -           -          smtpd* (рис. [-@fig:143]), (рис. [-@fig:144])

![Задание №24. Открытие файла /etc/postfix/master.cf (2)](image/ST2_143.png){#fig:143 width=70%}

![Задание №24. Редактирование файла /etc/postfix/master.cf (3)](image/ST2_144.png){#fig:144 width=70%}

Создадим пользователя student: *saslpasswd2 -c student@adm.org*. На запрос паролей наберём: P@ssw0rd (рис. [-@fig:145])

![Задание №24. Создание пользователя student](image/ST2_145.png){#fig:145 width=70%}

Проверим успешность создания пользователя, для этого выполним: *sasldblistusers2*. Результатом должна быть строка: student@adm.org: userPassword (рис. [-@fig:146])

![Задание №24. Проверка успешного создание пользователя](image/ST2_146.png){#fig:146 width=70%}

Добавим пользователя student в список postfix, в файл /etc/aliases добавим строку: *student: student* (рис. [-@fig:147]), (рис. [-@fig:148])

![Задание №24. Открытие файла /etc/aliases](image/ST2_147.png){#fig:147 width=70%}

![Задание №24. Редактирование файла /etc/aliases](image/ST2_148.png){#fig:148 width=70%}

Далее выполняем: *postalias /etc/aliases* (рис. [-@fig:149])

![Задание №24. postalias /etc/aliases](image/ST2_149.png){#fig:149 width=70%}

Перезапустим postfix: *systemctl restart postfix* (рис. [-@fig:150])

![Задание №24. Перезапуск postfix](image/ST2_150.png){#fig:150 width=70%}

Протестируем работу почтовых сервисов на самом сервере (рис. [-@fig:151])

![Задание №24. Тестирование работы почтовых сервисов](image/ST2_151.png){#fig:151 width=70%}

Далее необходимо открыть/пробросить порты IMAP и SMTP. Для этого на запущенной ВМ переходим в: Устройства->Сеть->Настроить сеть, кнопка Дополнительно, Проброс портов. Нажимаем +, порт хоста - 1143, порт гостя - 143. Снова нажимаем +, порт хоста - 1025, порт гостя - 25 (рис. [-@fig:152])

![Задание №24. Проброс портов](image/ST2_152.png){#fig:152 width=70%}

Запускаем со своего компьютера почтового клиента Thunderbird и тестируем работу почтового сервера. Нажимаем *Выберите, что нужно настроить, Электронная почта* (рис. [-@fig:153])

![Задание №24. Настройка электронной почты](image/ST2_153.png){#fig:153 width=70%}
...
![Задание №24. Ввод данных (1)](image/ST2_154.png){#fig:154 width=70%}
...
После нажимаем кнопки «Перетестировать» и «Готово» (рис. [-@fig:155])

![Задание №24. Ввод данных (2)](image/ST2_155.png){#fig:155 width=70%}

ПЕреходим на созданную учётную запись, нажимаем на правую кнопку мыши на учётной записи и выбираем «Подписаться..», выбираем галочками папки Sent и Trash (рис. [-@fig:156])

![Задание №24. Sent и Trash](image/ST2_156.png){#fig:156 width=70%}

При нажатии на Входящие должны получить ранее отправленное письмо с темой «Test» и содержанием «Hello» (рис. [-@fig:157])

![Задание №24. Полученные сообщения](image/ST2_157.png){#fig:157 width=70%}

Необходимо протестировать отправку писем по SMTP. Для этого нажимаем Ответить на письмо, отправляем в свой адрес student@adm.org и получаем с сервера этот ответ (рис. [-@fig:158])

![Задание №24. Полученный ответ](image/ST2_158.png){#fig:158 width=70%} 

После этого практическая работа считается выполненной (рис. [-@fig:159])

![Задание №24](image/ST2_159.png){#fig:159 width=70%} 

## Итоговая анкета

Задание №25: на скрине всё видно (рис. [-@fig:160])

![Задание №25](image/ST2_160.png){#fig:160 width=70%} 

Задание №26: на скрине всё видно (рис. [-@fig:161])

![Задание №26](image/ST2_161.png){#fig:161 width=70%} 

Задание №27: на скрине всё видно (рис. [-@fig:162])

![Задание №27](image/ST2_162.png){#fig:162 width=70%} 

Задание №28: на скрине всё видно (рис. [-@fig:163])

![Задание №28](image/ST2_163.png){#fig:163 width=70%} 

Задание №29: на скрине всё видно (рис. [-@fig:164])

![Задание №29](image/ST2_164.png){#fig:164 width=70%} 

Задание №30: на скрине всё видно (рис. [-@fig:165])

![Задание №30](image/ST2_165.png){#fig:165 width=70%} 

Задание №31: на скрине всё видно (рис. [-@fig:166])

![Задание №31](image/ST2_166.png){#fig:166 width=70%} 
